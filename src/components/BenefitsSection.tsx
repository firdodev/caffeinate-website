      ...
      <div className='container'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='order-2 lg:order-1'>
            <div className='relative h-[500px] w-full'>
              <div className='absolute top-0 left-0 w-3/4 h-3/4 bg-white shadow-lg rounded-2xl overflow-hidden'>
                <img src='/2.jpg' alt='Person using café app' className='w-full h-full object-cover' />
              </div>
              <div className='absolute bottom-0 right-0 w-2/3 h-2/3 bg-white shadow-lg rounded-2xl overflow-hidden'>
                <img src='/3.jpg' alt='Coffee and mobile app' className='w-full h-full object-cover' />
          ...
          <div className='order-1 lg:order-2'>
            <h2 className='font-poppins text-3xl md:text-4xl font-bold text-coffee-dark mb-6'>
              Why Use Our Digital Café App?
            </h2>
            <p className='text-gray-600 mb-8'>
              Our app is designed to make your café experience smoother, more personalized, and more rewarding. Say
              goodbye to waiting in lines and hello to a tailored coffee journey.
            </p>
