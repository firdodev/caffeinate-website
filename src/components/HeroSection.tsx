        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='flex flex-col space-y-6 animate-fade-in'>
            ...
            <p className='text-lg md:text-xl text-gray-600 max-w-lg'>
              Personalize your orders, earn rewards, gift to friends, and order from your table with just a scan - all
              in one digital café companion.
            </p>
            <div className='flex flex-wrap gap-4 pt-4'>
              ...
              <Button
                variant='outline'
                className='border-coffee-dark text-coffee-dark hover:bg-coffee-cream px-8 py-6 text-lg'
              >
                Learn More
              </Button>
            </div>
            <div className='flex items-center gap-4 pt-2'>
              <div className='flex -space-x-2'>
                <div className='w-8 h-8 rounded-full bg-coffee-dark flex items-center justify-center text-white text-xs'>
                  JD
                </div>
                <div className='w-8 h-8 rounded-full bg-coffee-medium flex items-center justify-center text-white text-xs'>
                  KL
                </div>
                <div className='w-8 h-8 rounded-full bg-coffee-light flex items-center justify-center text-white text-xs'>
                  MR
                </div>
              </div>
